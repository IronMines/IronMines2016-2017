...
5/  on génère les images positives.
>opencv_createsamples -img cylindre.png -bg bg.txt -info info/info.lst -pngoutput info -maxxangle 0.5 -maxyangle 0.5 maxzangle 0.5 -num 5000 
